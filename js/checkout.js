...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        /* DELIVERY CALCULATOR STYLED ROWS WITH ICONS */
        .calc-row {
            display: flex;
        ...
        /* CALCULATED DELIVERY DISPLAY ROW */
        .delivery-result-box {
            background: #f0fdf4;
            border-color: #bbf7d0;
        }
        ...
        .payment-option.disabled-option { opacity: 0.6; background: #f8fafc; cursor: not-allowed; }
        ...
        .trust-badge-pill i { font-size: 16px; color: #0284c7; }
...
<div class="checkout-container">
    ...
    <!-- LEFT COLUMN: Calculator, Customer Details & Dark EFT -->
    <div class="checkout-main">
        
        <!-- 1. IMPRESSIVE DELIVERY CALCULATOR (TOP TO MIDDLE LEFT) -->
        <div class="checkout-card">
            <h2><i class="fa-solid fa-truck-ramp-box" style="color: var(--primary);"></i> Express Courier & Delivery Calculator</h2>

            <!-- ROW 1: DISPATCH WAREHOUSE (SECURITY SHOP ICON) -->
            <div class="calc-row">
            ...
            <!-- ROW 2: CUSTOMER ADDRESS (HOME ICON) -->
            <div class="calc-row">
                <div class="calc-icon-box">
            ...
            <div class="calc-row">
                ...
                <div class="calc-content">
                    ...
                    <div style="display: flex; gap: 10px;">
                        <input type="number" id="distance-km" class="form-control" placeholder="Auto-detect or type KM" min="0" step="0.1">
            ...
            <!-- ROW 4: ACTUAL CALCULATED AMOUNT (DELIVERY VEHICLE ICON) -->
        ...
        <!-- 3. PAYMENT METHODS WITH DARK CAPITEC EFT LAYOUT -->
        <div class="checkout-card">
            <h2><i class="fa-solid fa-credit-card" style="color: var(--primary);"></i> Select Payment Method</h2>

            <!-- OPTION 1: CAPITEC PAY & INSTANT EFT (ACTIVE DARK CSS BLOCK) -->
            <div class="payment-option active">
                ...
                <!-- DARK CSS LAYOUT BLOCK FOR CAPITEC -->
                <div class="dark-eft-card">
                    <div class="qr-bank-grid">
                        <div style="text-align: center;">
                            <img src="assets/capitec-qr.jpg" alt="Capitec Scan to Pay" class="capitec-qr-img">
                            <div class="qr-caption">Scan with Capitec App</div>
                        </div>

                        <!-- BANKING DETAILS EXACT FORMAT -->
            ...
            <!-- OPTION 2: PAYFAST (UNDER MAINTENANCE) -->
    ...
    <!-- BOTTOM OF PAGE: TRUST & COURIER PARTNERS FOOTER -->
    <div class="trust-footer">
        <h4>Guaranteed Secure Payments & Trusted National Express Logistics</h4>
        <div class="badge-grid">
            <div class="trust-badge-pill"><i class="fa-solid fa-bolt"></i> Professional Instant EFT</div>
            <div class="trust-badge-pill"><i class="fa-solid fa-building-columns"></i> Capitec Pay</div>
            <div class="trust-badge-pill"><i class="fa-brands fa-cc-visa"></i> Visa</div>
            <div class="trust-badge-pill"><i class="fa-brands fa-cc-mastercard"></i> Mastercard</div>
            <div class="trust-badge-pill"><i class="fa-solid fa-shield-cat"></i> PayFast Gateway</div>
            <div class="trust-badge-pill"><i class="fa-solid fa-truck-ramp-box"></i> The Courier Guy</div>
            <div class="trust-badge-pill"><i class="fa-solid fa-box-archive"></i> KT Couriers</div>
        </div>
    </div>
